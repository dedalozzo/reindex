...
<div id="content">
  ...
  <aside class="column-right">
    ...
    <ul class="list vertical gutter even">
      <li><a class="badge" href="//{{ serverName~'/'~controllerPath }}bronzo/"><i class="icon-certificate bronze"></i> Bronzo</a></li>
      <li>Servono ad incoraggiare gli utenti a provare nuove funzionalità del sito. Sono facili da ottenere se vuoi tentare!</li>
      <li><a class="badge" href="//{{ serverName~'/'~controllerPath }}argento/"><i class="icon-certificate silver"></i> Argento</a></li>
      ...
      <li><a class="badge" href="//{{ serverName~'/'~controllerPath }}oro/"><i class="icon-certificate gold"></i> Oro</a></li>
