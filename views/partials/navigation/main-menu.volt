<ul class="list pills large gutter-plus">
  ...
  <li><a class="btn blue" href="#"><i class="icon-question"></i> FAI UNA DOMANDA</a></li>
  {% elseif controllerName == 'links' %}
  <li><a class="btn blue" href="#"><i class="icon-link"></i> AGGIUNGI UN LINK</a></li>
  {% elseif controllerName == 'blog' %}
    <li><a class="btn blue" href="#"><i class="icon-code"></i> SCRIVI SUL BLOG</a></li>
  {% endif %}
</ul>